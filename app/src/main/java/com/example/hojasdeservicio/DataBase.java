...
public class DataBase extends SQLiteOpenHelper {
    ...
    private static final String _tablaServicios = "CREATE TABLE servicios(num_servicio INTEGER PRIMARY KEY AUTOINCREMENT, id_lugar INTEGER NOT NULL, persona_reporta TEXT NOT NULL, correo_electronico TEXT NOT NULL, descripcion_reporte TEXT NOT NULL, descripcion_servicio TEXT, fecha_ini TEXT NOT NULL, fecha_fin TEXT, firma BLOB, FOREIGN KEY(id_lugar) REFERENCES lugares(id_lugar) ON DELETE CASCADE)";
