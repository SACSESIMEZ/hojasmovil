...
public class DataBase extends SQLiteOpenHelper {
    ...
    private static final String _tablaServicios = "CREATE TABLE servicios(num_servicio INTEGER PRIMARY KEY AUTOINCREMENT, id_servicio INTEGER, persona_reporta TEXT NOT NULL, correo_electronico TEXT, descripcion TEXT NOT NULL, fecha_ini TEXT NOT NULL, fecha_fin TEXT, id_lugar INTEGER, firma BLOB, FOREIGN KEY(id_lugar) REFERENCES lugares(id_lugar) ON DELETE CASCADE)";
